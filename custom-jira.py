...
################################################## USER PARAMETERS ###################################################
​
project_key = 'OI'     # You can get this from the beggining of an issue key. For example, WS for issue key WS-5018
issuetype_name = 'Security Task'  # Check https://confluence.atlassian.com/jirakb/finding-the-id-for-issue-types-646186508.html. There's also an API endpoint to get it.
